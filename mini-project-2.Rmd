...
write_csv(barrier_entrance, here::here("output", "barrier_entrance.csv"))
```
...
saveRDS(lin_reg_percent_accessible, file = "lin_reg_percent_accessible.rds", ascii = FALSE, version = NULL, compress = TRUE)%>%
  here::here("output")
readRDS("lin_reg_percent_accessible.rds")
```
