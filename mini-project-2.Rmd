...
<!-------------------------- Start your work below ---------------------------->
```{r}
#I want to convert the apt_buildings_heat_categories dataset from Milestone 1 to a csv in my output folder 

write_csv(apt_buildings_heat_categories, here::here("output", "apt_buildings_heat_categories.csv"))
```
<!----------------------------------------------------------------------------->
